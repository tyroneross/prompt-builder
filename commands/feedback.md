---
name: feedback
description: Report a bug or send feedback about the prompt-builder plugin
---

# Report prompt-builder feedback

File the user's report as a GitHub issue on `tyroneross/prompt-builder`. Issues are this plugin's
...
5. If `gh` is missing or unauthenticated, do not fail — print the URL so the user
   can open it in a browser: https://github.com/tyroneross/prompt-builder/issues/new
